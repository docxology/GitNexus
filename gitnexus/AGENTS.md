# Codomyrmex Agents — src/codomyrmex/git_analysis/vendor/gitnexus/gitnexus
...
- `hooks/` – Directory containing hooks components
...
- `test/` – Directory containing test components
